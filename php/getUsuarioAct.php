...
/* Consulta SQL */
$sql = "SELECT idUsuario, Departamento_idDepartamento as departamento, rol, apellidoPaterno, apellidoMaterno, nombre, sexo, contrato, RFC, CURP, fechaNacimiento, telefono, Correo, horas, nivel, perfilDeseable, activo, funcionAdministrativa FROM usuario
        WHERE idUsuario = '$id'";
